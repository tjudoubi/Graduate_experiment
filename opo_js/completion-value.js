...
shouldBe(eval(`99; switch (1) { case 1:  }`), undefined);
shouldBe(eval(`99; switch (1) { case 1: 42 }`), 42);
shouldBe(eval(`99; switch (1) { case 1: break; }`), undefined);
shouldBe(eval(`99; switch (1) { case 1: break; }`), undefined);
shouldBe(eval(`99; switch (1) { case 2: case 1:  }`), undefined);
...
shouldBe(eval(`99; switch (1) { case 1: case 2:  }`), undefined);
...
shouldBe(eval(`99; switch (1) { case 1: 42; case 2:  }`), 42);
...
shouldBe(eval(`99; switch (1) { case 0: -1; break; case 1: ; break; default: -1; break; }`), undefined);
shouldBe(eval(`99; switch (1) { case 0: -1; break; case 1: 42; break; default: -1; break; }`), 42);
